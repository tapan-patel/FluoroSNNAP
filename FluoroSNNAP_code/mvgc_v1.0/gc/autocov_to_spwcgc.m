...
multiWaitbar('GC - frequency domain. Overall progress:',0,'Name','Please wait');
multiWaitbar('Autocovariance',0,'Name','Please wait');
...
for j = 1:n
     multiWaitbar('GC - frequency domain. Overall progress:',j/n);
 ...
 multiWaitbar('GC - frequency domain. Overall progress:',1,'Color','g');