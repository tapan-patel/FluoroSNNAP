...
load('params.mat');
    ...
    errordlg('Params.mat does not exist. Please run Analysis -> Preferences');
    return;
end
if nargin < 2, V = struct;   end         % create structure for algorithmic variables, if none provided
V.fast_iter_max = params.spike_inference_iter;
V.smc_iter_max = 0;
V.dt = 1/params.fps;
V.preprocess = params.spike_inference_filter;
V.plot = 0;
